...
```{python}
#adicionamos o if not exist para se ja tiver nao tentar criar denovo com o mesmo nome pois daria erro

#apagando tambem a tabela para ter certeza que ao rodar o codigo denovo os resultados nao serao alterados
