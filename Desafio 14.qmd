...
```{python}
#!pip install plotnine #instalando o pacote com o diamonds
```
...
plot.save("plot.png")  # Pode-se adicionar width, height e dpi para maior controle do tamanho e resolução
...
# Salva o gráfico como arquivo PNG
plot2.save("plot2.png")  # Pode-se adicionar width, height e dpi para controlar o tamanho e resolução
...
# Salva o gráfico como arquivo PNG
plot3.save("plot3.png")  # Pode-se adicionar width, height e dpi para controlar tamanho e resolução
